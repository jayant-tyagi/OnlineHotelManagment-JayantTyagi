...
const AddUser = () => {
    ...
    const postDataToServer = (data) => {
        axios.post(`${base_url}owner/ManageUser/adduser`, data, {
            headers: {
                "Access-Control-Allow-Headers": "Content-Type",
                "Access-Control-Allow-Methods": "*",
    ...
    return (
        <div>
            < Header />
            <div className="div2">
                <h2 className="text-center my-3" style={{ fontFamily: "fantasy", fontStyle: "italic", textDecoration: "underline" }}>Fill User Details</h2>
