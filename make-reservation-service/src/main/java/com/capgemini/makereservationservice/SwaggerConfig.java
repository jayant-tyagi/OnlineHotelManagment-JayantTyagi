...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private ApiInfo apidetails() {
    	return new ApiInfo(
    			"Make Reservation",
    			"It manages all the reservations which are done in the Hotel.",
    			"1.0",
    			"Free to use",
    			new springfox.documentation.service.Contact("Jayant Tyagi","http://localhost:8086","tyagijayant03@gmail.com"),
    			"API Licence",
    			"http://localhost:8086",
