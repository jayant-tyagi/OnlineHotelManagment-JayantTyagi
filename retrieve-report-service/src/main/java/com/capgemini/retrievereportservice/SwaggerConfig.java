...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private ApiInfo apidetails() {
    	return new ApiInfo(
    			"Retrieve Report",
    			"It retrieves all the payment and income report in the Hotel",
    			"1.0",
    			"Free to use",
    			new springfox.documentation.service.Contact("Jayant Tyagi","http://localhost:8084","tyagijayant03@gmail.com"),
    			"API Licence",
    			"http://localhost:8084",
